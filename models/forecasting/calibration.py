...
def fit_offsets(lo, hi, actual, groups, coverage: float) -> dict:
    """Per group, the amount to widen [lo, hi] so it covers `coverage` of calibration outcomes (Romano et al. 2019)."""
    offsets = {}
