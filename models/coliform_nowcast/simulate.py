"""Simulate sensors, weather and weekly lab results (including total coliform) for lakes fed by sewage and runoff."""
...
def simulate(days: int = 455, seed: int = 61, stations: dict = STATIONS):
    """Return (10-minute sensor readings, hourly weather, weekly lab results with total_coliform)."""
    return simulate_lab_world(days, seed, stations, coliform=True)
